  ...
  constructor(props) {
    ...
    _defineProperty(this, "renderFile", (file, focused, expanded) => {
      ...
      return _react.default.createElement("div", {
        ...
        className: "file-path"
      }, file.filepath ? (0, _utils.getRelativePath)(file.filepath) : (0, _source.getFormattedSourceId)(file.sourceId)), _react.default.createElement("span", {
    ...
    _defineProperty(this, "renderMatch", (match, focused) => {
      return _react.default.createElement("div", {
        ...
        key: match.line
      }, match.line), this.highlightMatches(match));
    });
