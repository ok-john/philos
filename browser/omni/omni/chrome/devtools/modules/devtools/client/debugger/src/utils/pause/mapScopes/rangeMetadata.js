...
async function loadRangeMetadata(location, originalAstScopes, sourceMapLoader) {
  const originalRanges = await sourceMapLoader.getOriginalRanges(location.sourceId);
