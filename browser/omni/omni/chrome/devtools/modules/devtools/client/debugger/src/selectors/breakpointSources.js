...
const _getSourcesForBreakpoints = (breakpoints, sourcesMap, selectedSource, blackBoxRanges) => {
...
const getBreakpointSources = (0, _reselect.createSelector)(_breakpoints.getBreakpointsList, _sources.getSourcesMap, _sources.getSelectedSource, _sourceBlackbox.getBlackBoxRanges, (breakpoints, sourcesMap, selectedSource, blackBoxRanges) => {
  ...
  return _getSourcesForBreakpoints(sortedVisibleBreakpoints, sourcesMap, selectedSource, blackBoxRanges);
});
