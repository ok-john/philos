...
const mapStateToProps = state => {
  return {
    ...
    tabs: (0, _selectors.getSourceTabs)(state).map(tab => {
      return {
        source: (0, _selectors.getSource)(state, tab.sourceId),
        sourceActor: (0, _selectors.getSourceActor)(state, tab.sourceActorId)
      };
