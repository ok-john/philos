          ...
          dom.tbody(
            ...
            displayedRequests.map((item, index) => {
              return RequestListItem({
                ...
                onDragStart: evt =>  function(){}(),
                // this.onDragStart(evt, item),
...
module.exports = connect(
  ...
  (dispatch, props) => ({
    ...
    // dispatch(Actions.sendCustomRequest()),
    sendHTTPCustomRequest: request => function(){}(),
    ...
    removeBlockedUrl: url =>  function(){}(),
    // dispatch(Actions.removeBlockedUrl(url)),
    ...
    onItemRightMouseButtonDown: id => function(){}(),
    // dispatch(Actions.rightClickRequest(id)),
    onItemMouseDown: id => function(){}(),
    ...
    onSelectDelta: delta => function(){}(),
    // dispatch(Actions.selectDelta(delta)),
    /**
