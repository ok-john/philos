...
class Tab extends _react.PureComponent {
  ...
  render() {
    ...
    const active = selectedLocation && sourceId == selectedLocation.sourceId && !this.isProjectSearchEnabled() && !this.isSourceSearchEnabled();
    ...
    function handleTabClick(e) {
      e.preventDefault();
      e.stopPropagation();
      return selectSource(cx, sourceId, sourceActor === null || sourceActor === void 0 ? void 0 : sourceActor.actor);
    }
