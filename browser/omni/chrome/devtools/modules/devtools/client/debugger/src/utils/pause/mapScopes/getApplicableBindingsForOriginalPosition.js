...
async function originalRangeStartsInside(source, {
  ...
  const startPosition = await sourceMapLoader.getGeneratedLocation(start); // If the start and end positions collapse into eachother, it means that
...
}, bindingType, locationType, sourceMapLoader) {
