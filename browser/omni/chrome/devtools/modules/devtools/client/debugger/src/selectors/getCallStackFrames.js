...
const getCallStackFrames = (0, _reselect.createSelector)(_pause.getCurrentThreadFrames, _sources.getSourcesMap, _sources.getSelectedSource, _sourceBlackbox.getBlackBoxRanges, formatCallStackFrames);
