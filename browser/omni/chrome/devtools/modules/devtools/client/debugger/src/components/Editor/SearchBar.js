...
class SearchBar extends _react.Component {
  ...
  static get propTypes() {
    return {
      ...
      searchResults: _propTypes.default.object.isRequired,
      selectedContentLoaded: _propTypes.default.bool.isRequired,
      ...
      toggleFileSearchModifier: _propTypes.default.func.isRequired,
      traverseResults: _propTypes.default.func.isRequired
    };
  }
...
const mapStateToProps = (state, p) => {
  ...
  return {
    ...
    selectedSource,
    selectedContentLoaded: selectedLocation ? !!(0, _selectors.getSettledSourceTextContent)(state, selectedLocation) : false,
