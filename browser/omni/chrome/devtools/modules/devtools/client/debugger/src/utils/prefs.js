...
const {
  PrefsHelper
} = require("devtools/client/shared/prefs");
...
const prefs = new PrefsHelper("devtools", {
  ...
  projectDirectoryRootName: ["Char", "debugger.project-directory-root-name", ""],
...
const asyncStore = ThreadUtils.asyncStore;
